...
import { ngPembelian, type NgReportRange } from "@/lib/ngReports";
import { NgPembelianClient } from "./NgPembelianClient";
...
export default async function NonGudangPembelianPage({
  searchParams,
}: {
    ...
    return (
      <div className="rounded-xl border border-red-200 bg-red-50 p-6 dark:border-red-900/50 dark:bg-red-950/20">
        ...
        <p className="mt-2 text-sm text-red-700 dark:text-red-400">
          Riwayat pembelian non-gudang hanya diizinkan untuk <strong>Admin Non-Gudang</strong>.
        </p>
      </div>
    );
  }
  ...
  const data = await ngPembelian(range);
